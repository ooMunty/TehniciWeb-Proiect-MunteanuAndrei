...
app.get("/rolagalerie", function(req,res) {
    res.render("pagini/rolagalerie", {imagini: obGlobal.obImagini.imagini}); //necesar pt galerie pentru a putea afisa imaginile
})
...
app.get("{/*path}.ejs", function(req, res, next){
